function revisar() {
    ...
    var a = 0;
    var e = 0;
    var pregunta1 = document.uno[2].checked;
    var pregunta2 = document.dos[1].checked;
    var pregunta3 = document.tres[0].checked;
    var pregunta4 = document.cuatro[1].checked;
    var pregunta5 = document.cinco[0].checked;
    if(pregunta1==false){
    puntos=puntos-16;
    e++;
    }else{
    ...
    return bien();
     ...
     //window.alert("Suerte la proxima " + e);
    return mal();
    }
 ...
 function siguiente(){
  //  window.location = "numerosev2.html";
