Swal.fire({
  ...
  imageUrl:'img/recordatorio1.gif', 
  color: '#716add',
  ...
  html: '<b><p>Pudes dar click sobre la primer imagen para escuchar el sonido</p></b> '
});
function siguiente(){
  window.location = "abecedario2.html";
...
function bien(){
  Swal.fire({
    ...
    +'<button class="btn btn-success" onclick="regresar()">Menu</button>'
    ,
    showCloseButton: true,
