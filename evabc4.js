function revisar() {
    ...
    var a = 0;
    var e = 0;
    var pregunta1 = document.uno.uno[2].checked;
    var pregunta2 = document.dos.dos[0].checked;
    var pregunta3 = document.tres.tres[1].checked;
    var pregunta4 = document.cuatro.cuatro[0].checked;
    var pregunta5 = document.cinco.cinco[1].checked;
    if(pregunta1==false){
    puntos=puntos-16;
    e++;
    }else{
 ...
 function siguiente(){
    window.location = "abecedarioev5.html";
